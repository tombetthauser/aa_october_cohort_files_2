...
// 12min - checked solution 3-5 times - fixed basic bugs
// 7min - peeked at handwritten notes twice for structure - only one 2sec bug
// 7.5min - no notes - only 2 little 2sec bugs!
// 6min - no bugs no notes!
// 8min - no bugs no notes!